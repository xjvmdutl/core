...
public class ApplicationContextBasicFindTest {
    ...
    public void findBeanByType() {
        MemberService memberService = applicationContext
            .getBean(MemberService.class); //타입으로 조회
        Assertions.assertThat(memberService).isInstanceOf(MemberServiceImpl.class);
    }
    ...
    public void findBeanByName2() {
        //스프링 빈을 반환 인스턴스 타입으로 접근하기 때문에 구현 클래스로 조회도 된다
        //물론 좋지 않다(구체클래스에 의존)
        MemberServiceImpl memberService = applicationContext
    ...
    public void findBeanByNameX() {
        assertThrows(NoSuchBeanDefinitionException.class, () ->
            applicationContext.getBean("xxxxxx", MemberServiceImpl.class))
